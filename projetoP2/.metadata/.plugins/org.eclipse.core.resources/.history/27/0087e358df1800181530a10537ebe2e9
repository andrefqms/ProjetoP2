...
public class ControllerAlunoTest {
	...
	public void testRecuperaAluno() {
		controller.cadastrarAluno("Daniel", "116210607", 22, "98485-5554", "daniel.jose.leite@ccc.ufcg.edu.br");
		assertEquals("116210607 - Daniel - 22 - 98485-5554 - daniel.jose.leite@ccc.ufcg.edu.br", controller.recuperaAluno("116210607"));
		controller.cadastrarAluno("Matthew Melio", "115260904", 10000, "", "matthew.met@ccc.ufcg.edu.br");
		assertEquals("115260904 - Matthew Melio - 10000 - matthew.met@ccc.ufcg.edu.br",	controller.recuperaAluno("115260904"));
	}
	...
	public void testListarAlunos() {
		controller.cadastrarAluno("Daniel", "116210607", 22, "98485-5554", "daniel.jose.leite@ccc.ufcg.edu.br");
		controller.cadastrarAluno("Matthew Melio", "115260904", 10000, "", "matthew.met@ccc.ufcg.edu.br");
		assertEquals("116210607 - Daniel - 22 - 98485-5554 - daniel.jose.leite@ccc.ufcg.edu.br, 115260904 - Matthew Melio - 10000 - matthew.met@ccc.ufcg.edu.br", controller.listarAlunos());
	}
}
